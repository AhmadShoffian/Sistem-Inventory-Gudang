        ...
        <div class="w-full mx-auto items-center flex justify-between md:flex-nowrap flex-wrap md:px-16 px-4">
            <div>
                ...
                <p class="mt-2 md:mt-3 text-sm md:text-base leading-relaxed text-white opacity-80">
                    Silakan isi data satuan barang yang ingin ditambahkan ke dalam sistem inventaris.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="px-6 -mt-32">
        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
            <div class="rounded-t px-6 py-3 border-0 bg-blueGray-50">
                <h3 class="font-semibold text-base text-blueGray-700">Form Tambah Satuan</h3>
            </div>

            <div class="px-6 py-6">
                <form method="POST" action="{{ route('staff.satuan.store') }}">
                    @csrf

                    {{-- Nama Kategori --}}
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-blueGray-600 mb-1">Nama Satuan</label>
